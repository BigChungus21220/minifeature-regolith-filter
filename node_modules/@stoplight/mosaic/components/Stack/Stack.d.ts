...
import { IFlexShorthandProps, Responsive } from '../../enhancers';
import { PolymorphicComponentProps } from '../Box';
export declare type StackSpacingVals = 1 | 2 | 3 | 4 | 5 | 6 | 8 | 10 | 12 | 14 | 16 | 20 | 24 | 32;
declare type DirectionVals = 'vertical' | 'horizontal';
export declare type StackOwnProps = Pick<IFlexShorthandProps, 'align' | 'justify' | 'wrap'> & {
    /**
     * The direction to render the stack
     */
    direction?: DirectionVals | Responsive<DirectionVals>;
    /**
     * The space between each stack item
     */
    spacing?: StackSpacingVals | Responsive<StackSpacingVals>;
    /**
