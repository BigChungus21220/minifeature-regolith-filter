...
import { DatasetProps } from '../Box';
import { ButtonProps } from '../Button';
import { FieldButtonAppearanceVals } from '../Button/variants';
import { IIconProps } from '../Icon';
export declare type SelectProps = AriaLabelingProps & DatasetProps & {
    /**
     * Items in the select.
     */
    ...
    name?: string;
    /**
     * The class name to add to the Select container.
     */
    className?: string;
    /**
    ...
    /**
     * Optional additional properties to pass directly to the trigger element.
     */
