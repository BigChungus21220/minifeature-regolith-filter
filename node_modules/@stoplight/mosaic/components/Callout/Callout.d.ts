...
export declare type CalloutProps = BoxProps<React.ElementType> & {
    ...
    /**
     * Controls whether the callout content goes all the way to bottom outline or not
     */
...
} & import("../../enhancers").BorderWidthProps & import("../../enhancers").BorderRoundedProps & import("../../enhancers").IRingProps & import("../../enhancers").IInteractivityProps & import("../../enhancers").IFlexProps & import("../../enhancers").IPositionProps & import("../../enhancers").TransformProps & import("../../enhancers").ILayoutProps & import("../Box").DatasetProps & {
