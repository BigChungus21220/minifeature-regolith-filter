...
export declare type TabProps<E extends React.ElementType = 'div'> = PolymorphicComponentProps<E, TabsOwnProps>;
export declare const Tabs: <E extends React.ElementType = 'div'>(props: TabProps<E>) => JSX.Element;
